...
import { type IAppointmentsRepository } from "../../../src/modules/appointments/domain/IAppointmentsRepository.js";
import { describe, it, expect, beforeEach, vi } from "vitest";

describe("AppointmentsService - Testes Unitários", () => {
  let appointmentsRepositoryMock: IAppointmentsRepository;
